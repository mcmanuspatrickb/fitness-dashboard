...
# Fasting-specific analysis remains on-demand. The automatic path is centered
# on fat loss, muscle preservation, recovery, and phase-aware feedback.
PIPELINE = [
    ...
    ("25_build_performance_markers.py", "Build grip and waist performance markers"),
    ...
    ("77_phase_detection.py", "Determine current coaching phase"),
    ("78_cut_stress_guardrail.py", "Build cut stress and recovery guardrail"),
...
def main() -> None:
    ...
    log_lines.extend([
        ...
        f"Duration: {finished_at - started_at}",
